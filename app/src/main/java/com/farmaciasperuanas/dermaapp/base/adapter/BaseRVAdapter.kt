package com.farmaciasperuanas.dermaapp.base.adapter
...
import com.farmaciasperuanas.dermaapp.base.Status

abstract class BaseRVAdapter<T>(val ctx: Context?, var resource: Resource<List<T>>) :
    ...
    fun submitData(data: Resource<List<T>>?, recyclerView: RecyclerView, T: Any?) {
        data?.let {
            resource = it
            ...
            if (data.status == Status.ERROR) {
                ...
                recyclerView.layoutManager = T as RecyclerView.LayoutManager?
            }
